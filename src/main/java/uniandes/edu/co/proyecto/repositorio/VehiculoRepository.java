...
public interface VehiculoRepository extends JpaRepository<Vehiculo, Integer> {
    ...
    @Modifying
    @Transactional
    @Query(value= "UPDATE Vehiculo SET tipo=: tipo, marca=: marca, modelo=: modelo, color=: color, placa=: placa, capacidad=: capacidad, Ciudad_id=: Ciudad_id, Ucond_idcond=: Ucond_idcond, Ucond_idusuario=: Ucond_idusuario WHERE id =:id", nativeQuery = true)
    void actualizarVehiculo(@Param("id") int id, @Param("tipo") String tipo, @Param("marca") String marca, @Param("modelo") String modelo, @Param("color") String color, @Param("placa") String placa, @Param("capacidad") int capacidad, @Param("Ciudad_id") int Ciudad_id, @Param("Ucond_idcond") int Ucond_idcond, @Param("Ucond_idusuario") int Ucond_idusuario);
