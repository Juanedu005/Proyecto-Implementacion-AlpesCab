...
public interface UserviciosRepository extends JpaRepository<Uservicios, UserviciosPK> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO Uservicios (id_servicios, id_usuario, nombre_tc, numero_tc, fecha_vencimiento, cv) VALUES ( :id_servicios, :id_usuario, :nombre_tc, :numero_tc, :fecha_vencimiento, :cv)", nativeQuery = true)
