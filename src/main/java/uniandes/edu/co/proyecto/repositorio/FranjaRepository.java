...
public interface FranjaRepository extends JpaRepository<Franja, Integer> {
    ...
    void actualizarFranja(@Param("id_franja") int id_franja, @Param("hora_inicio") LocalDateTime hora_inicio, @Param("hora_fin") LocalDateTime hora_fin, @Param("ocupado") Boolean ocupado, @Param("Vehiculo_id") int Vehiculo_id, @Param("Ucond_idcond") int Ucond_idcond, @Param("Ucond_idusuario") int Ucond_idusuario);
